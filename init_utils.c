...
void	init_blocks(t_map *map)
{
	...
	map->block->hero_block_2 = mlx_xpm_file_to_image(map->mlx,
			"./textures/characters/hero/_2.xpm", &h, &w);
	map->block->enemy_block_1 = mlx_xpm_file_to_image(map->mlx,
			"./textures/characters/enemy/_1.xpm", &h, &w);
	map->block->enemy_block_2 = mlx_xpm_file_to_image(map->mlx,
			"./textures/characters/enemy/_2.xpm", &h, &w);
	map->block->enemy_block_3 = mlx_xpm_file_to_image(map->mlx,
			"./textures/characters/enemy/_3.xpm", &h, &w);
}
